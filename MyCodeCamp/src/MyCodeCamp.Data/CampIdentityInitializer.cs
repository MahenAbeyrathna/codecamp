...
namespace MyCodeCamp.Data
{
  public class CampIdentityInitializer
  {
    ...
    {
      var user = await _userMgr.FindByNameAsync("mahenabeyrathna");
      ...
      if (user == null)
      {
        ...
        user = new CampUser()
        {
          UserName = "mahenabeyrathna",
          FirstName = "Mahen",
          LastName = "Abeyrathna",
          Email = "msabeyrathna@gmail.com.com"
        };
      
        var userResult = await _userMgr.CreateAsync(user, "123");
