    ...
    public class CampsController : BaseController
    {
        ...
        public async Task<IActionResult> Put(string moniker, [FromBody] CampModel model)
        {
            try
            {
                ...
                if(oldCamp == null) { return NotFound($" colud not find a camp with ID of :{moniker}"); }
        ...
        public async Task<IActionResult> Delete( string moniker)
        {
            ...
            {
                var oldCamp = _repo.GetCampByMoniker(moniker);
                if(oldCamp == null) { return NotFound($"could not found camp with ID of : {moniker}"); }
            ...
            return BadRequest("Couldn't not delete Camp:");
        }
    }
}
